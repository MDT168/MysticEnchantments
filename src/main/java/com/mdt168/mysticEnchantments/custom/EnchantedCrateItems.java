...
public class EnchantedCrateItems {
    public static final EnchantedItem ARCANE_AMPLIFIER = new EnchantedItem(
            "Arcane Amplifier",
    ...
    public static final EnchantedItem DIAMONDS_BLOCKS = new EnchantedItem(
            "Diamond Blocks",
    ...
    public static final EnchantedItem EMERALD_BLOCKS = new EnchantedItem(
            "Emerald Blocks",
    ...
    public static final EnchantedItem GOLD_BLOCKS = new EnchantedItem(
            "Gold Blocks",
    ...
    public static final EnchantedItem IRON_BLOCKS = new EnchantedItem(
            "Iron Blocks",
    ...
    public static final EnchantedItem GOLDEN_CARROTS = new EnchantedItem(
            "Golden Carrots",
    ...
    public static final EnchantedItem BASIC_ENCHANT = new EnchantedItem(
            "Basic Enchants",
    ...
    public static final EnchantedItem ENHANCED_ENCHANT = new EnchantedItem(
            "Enhanced Enchants",
    ...
    public static final EnchantedItem REFINED_ENCHANT = new EnchantedItem(
            "Refined Enchants",
    ...
    public static final EnchantedItem ELITE_ENCHANT = new EnchantedItem(
            "Elite Enchants",
    ...
    public static final EnchantedItem MYTHIC_ENCHANT = new EnchantedItem(
            "Mythic Enchants",
    ...
    public static final EnchantedItem NETHERITE_INGOTS = new EnchantedItem(
            "Netherite Ingots",
    ...
    public static final EnchantedItem SHARPNESS_VI = new EnchantedItem(
            "Sharpness VI (6)",
    ...
    public static final EnchantedItem FORTUNE_IV = new EnchantedItem(
            "Fortune IV (4)",
    ...
    public static final EnchantedItem EFFICIENCY_VI = new EnchantedItem(
            "Efficiency VI (6)",
    ...
    public static final EnchantedItem UNBREAKING_IV = new EnchantedItem(
            "Unbreaking IV (4)",
    ...
    public static final EnchantedItem MENDING = new EnchantedItem(
            "Mending",
    ...
    public static final EnchantedItem LOOTING_IV = new EnchantedItem(
            "Looting IV (4)",
    ...
    public static final EnchantedItem XP_2500 = new EnchantedItem(
            "2500 XP",
            "Obtain 2500 XP",
            10,
    ...
    public static final EnchantedItem XP_5000 = new EnchantedItem(
            "5000 XP",
            "Obtain 5000 XP",
            8,
            Material.EXPERIENCE_BOTTLE,
    ...
    public static final EnchantedItem XP_7500 = new EnchantedItem(
            "7500 XP",
            "Obtain 7500 XP",
            5,
            Material.EXPERIENCE_BOTTLE,
    ...
    public static final EnchantedItem ENCHANTED_GOLDEN_APPLE = new EnchantedItem(
